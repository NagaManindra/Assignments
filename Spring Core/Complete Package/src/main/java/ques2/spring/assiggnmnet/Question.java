...
/**
 * Set<String> answers; public Question(int questionId, String
 * question,Set<String> answers) { super(); this.questionId = questionId;
 * this.question =question; this.answers = answers; }
 **/

/**
 * Map<Integer, String> answers; public Question(int questionId, String
 * question, Map<Integer, String> answers) { super(); this.questionId =
 * questionId; this.question = question; this.answers = answers; }
 **/
