...
/**
 * Q2. Write an application using lambda expressions to print Orders having 2
 * criteria implemented: 1) order price more than 10000 2) order status is
 * ACCEPTED or COMPLETED.
 * 
 * Description:
 * 
 * Write a program in such a way that it has a method which returns the list of
 * orders satisfying the 2 conditions mentioned in the question.
 * 
 * Specifications:
 * 
 * import java.util.ArrayList;
 ...
 * 
 * private int totalPrice; private String status;
 * 
 * public static ArrayList<Assignment4Q2> listOfOrders(ArrayList<Assignment4Q2>
 * orders) {} public static void main(String[] args) {} }
 * 
 * @author Manindra
 *
 */
...
public class Assignment4Q2 {
	...
	private static void printAll(List<orderDetails> ordrList, Condition condition,
			Comparator<orderDetails> comparator) {
